...
const galleryData = [
  {
    ...
    variants: [
      { src: 'component/Gallery/Black-&-Orange.png', title: 'Main View' },
      { src: 'component/Image Variaant/Black-&-Orange-1.png', title: 'Side View' },
      { src: 'component/Image Variaant/Black-&-Orange-2.png', title: 'Detail View' },
      { src: 'component/Image Variaant/Black-&-Orange-3.png', title: 'Back View' },
      { src: 'component/Image Variaant/Black-&-Orange-4.png', title: 'Interior View' }
    ]
  },
  {
    ...
    colorCode: '#1E3A8A',
    variants: [
      { src: 'component/Gallery/Blue.png', title: 'Main View' }
    ]
  },
  {
    ...
    colorCode: '#DC2626',
    variants: [
      { src: 'component/Gallery/Red.png', title: 'Main View' }
    ]
  },
  {
    ...
    variants: [
      { src: 'component/Gallery/Dark-blue-&-white.png', title: 'Main View' },
      { src: 'component/Image Variaant/Dark-blue-&-white-1.png', title: 'Side View' },
      { src: 'component/Image Variaant/Dark-blue-&-white-2.png', title: 'Detail View' },
      { src: 'component/Image Variaant/Dark-blue-&-white-2 (2).png', title: 'Back View' },
      { src: 'component/Image Variaant/Dark-blue-&-white4.png', title: 'Interior View' }
    ]
  },
  {
    ...
    variants: [
      { src: 'component/Gallery/Black-&-Red.png', title: 'Main View' },
      { src: 'component/Image Variaant/Black-&-Red-1.png', title: 'Side View' },
      { src: 'component/Image Variaant/Black-&-Red-2.png', title: 'Detail View' },
      { src: 'component/Image Variaant/Black-&-Red-3.png', title: 'Back View' },
      { src: 'component/Image Variaant/Black-&-Red-4.png', title: 'Interior View' }
    ]
  }
];
